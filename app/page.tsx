...
export default function Home() {
  ...
  return (
    <div className="shadow-[0.5rem_0.5rem_0_black] w-4/5 flex flex-col md:flex-row items-center justify-center border-2 px-10 border-black rounded-xl">
      ...
      >
        <h1
          className={`${rubik.className} text-orange-400 italic text-5xl select-none`}
        >
          KTU Mailer
        </h1>
        <p className="text-center font-medium select-none">
          Wanna get the latest KTU notifications delivered straight to your
          inbox?
        </p>
        <p className="text-center italic select-none">
          Well, here&apos;s the subscription service just for that, enter you
          email below and let the service do its thing.
        </p>
        <form
        ...
        >
          <input
            ...
            className={`${
              ...
              !pristine && (valid ? "outline-green-600" : "outline-red-600")
            } `}
          />
          <button
